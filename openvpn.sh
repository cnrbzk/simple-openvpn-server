...
wget -O /etc/nginx/sites-available/default https://raw.githubusercontent.com/cnrbzk/simple-openvpn-server/master/default

#install the webserver scripts
rm /var/www/html/*
mkdir -p /var/www/html/
wget -O /var/www/html/index.sh https://raw.githubusercontent.com/cnrbzk/simple-openvpn-server/master/index.sh

wget -O /var/www/html/download.sh https://raw.githubusercontent.com/cnrbzk/simple-openvpn-server/master/download.sh
